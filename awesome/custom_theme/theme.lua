...
theme.font          = "DejaVuSansM Nerd Font 10"

theme.bg_normal     = "#1e252d"
theme.bg_focus      = "#8ca1a6"
theme.bg_minimize   = "#444444"

theme.fg_normal     = "#ffffff"
theme.fg_focus      = "#1e252d"
...
theme.wallpaper = gfs.get_configuration_dir() .. "custom_theme/halo.jpg"
